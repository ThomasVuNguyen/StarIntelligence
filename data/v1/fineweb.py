#!/usr/bin/env python3
"""
Stream and filter HuggingFaceFW/fineweb-edu dataset
Searches for geometry/3D printing related keywords in text and URL
Outputs filtered data to fineweb.json with resume capability
Stops at 5B words total
"""
...
def main():
    print("="*70)
    print("FineWeb-Edu Geometry/3D Printing Dataset Filter")
    print("="*70)
